...
filenameMNI = [STANCEroot,'/Resource/MNI/MNI152T1_1mm.nii'];
filenameGM  = [STANCEroot,'/Resource/MNI/MNI152gm_1mm.nii'];
...
subjectsBase = [STANCEroot,'/Resource/subjects/subject'];
...
fn_s04 = 'Resource/subjects/subject04/subject04_t1w_p0.nii.gz';
